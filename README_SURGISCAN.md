...
```
REACT_APP_BACKEND_URL=https://healthscan-parse.preview.emergentagent.com
```
...
```bash
# Health check
curl https://healthscan-parse.preview.emergentagent.com/api/health

# After Supabase setup, test patient creation:
curl -X POST https://healthscan-parse.preview.emergentagent.com/api/patients \
...
### Frontend
Visit: https://healthscan-parse.preview.emergentagent.com
...
3. Test API health: `curl https://healthscan-parse.preview.emergentagent.com/api/health`

## 🎉 Quick Start Summary

1. **Create Supabase tables** (see SUPABASE_SETUP_INSTRUCTIONS.md)
2. **Restart backend**: `sudo supervisorctl restart backend`
3. **Open app**: https://healthscan-parse.preview.emergentagent.com
