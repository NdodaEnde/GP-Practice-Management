...
```
REACT_APP_BACKEND_URL=https://healthcare-ehr.preview.emergentagent.com
```
...
```bash
# Health check
curl https://healthcare-ehr.preview.emergentagent.com/api/health

# After Supabase setup, test patient creation:
curl -X POST https://healthcare-ehr.preview.emergentagent.com/api/patients \
...
### Frontend
Visit: https://healthcare-ehr.preview.emergentagent.com
...
3. Test API health: `curl https://healthcare-ehr.preview.emergentagent.com/api/health`

## 🎉 Quick Start Summary

1. **Create Supabase tables** (see SUPABASE_SETUP_INSTRUCTIONS.md)
2. **Restart backend**: `sudo supervisorctl restart backend`
3. **Open app**: https://healthcare-ehr.preview.emergentagent.com
