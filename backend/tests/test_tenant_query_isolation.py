...
# ---------------------------------------------------------------------------
BASELINE: Set[str] = {
    # Regenerated 2026-05-21 (Pass C: also removed legacy backend/api/validation.py
    # router + its server.py import/include — shifted server.py line numbers).
    # Net new tenant-table queries: ZERO; line-drift only.
