...
# ---------------------------------------------------------------------------
BASELINE: Set[str] = {
    # Regenerated 2026-05-21 (line drift from Pass-A security hardening;
    # no new tenant-table queries — SSRF/rate-limit/docs only).
    ...
    "app/services/document_watcher.py::294::digitised_documents",
    "app/services/document_watcher.py::304::digitised_documents",
    "app/services/document_watcher.py::323::digitised_documents",
    "app/services/document_watcher.py::345::digitised_documents",
    "app/services/document_watcher.py::371::digitised_documents",
    "app/services/document_watcher.py::404::digitised_documents",
    "app/services/document_watcher.py::426::digitised_documents",
    "app/services/document_watcher.py::437::digitised_documents",
    "app/services/gp_processor.py::524::gp_validation_sessions",
    "app/services/gp_processor.py::542::gp_validation_sessions",
    "app/services/gp_processor.py::574::patients",
    "app/services/gp_processor.py::598::patients",
    "app/services/gp_processor.py::623::patients",
    ...
    "server.py::1074::patients",
    "server.py::1124::patients",
    "server.py::1138::patients",
    "server.py::1169::encounters",
    "server.py::1191::encounters",
    "server.py::1201::encounters",
    "server.py::1224::encounters",
    "server.py::1547::encounters",
    "server.py::1616::patients",
    "server.py::1741::digitised_documents",
    "server.py::1760::digitised_documents",
    "server.py::1795::digitised_documents",
    "server.py::1830::digitised_documents",
    "server.py::2017::gp_invoices",
    "server.py::2176::gp_invoices",
    "server.py::2275::digitised_documents",
    "server.py::2279::digitised_documents",
    "server.py::2321::digitised_documents",
    "server.py::2336::digitised_documents",
    "server.py::2425::digitised_documents",
    "server.py::2631::digitised_documents",
    "server.py::2773::patients",
    "server.py::2812::digitised_documents",
    "server.py::2891::digitised_documents",
    "server.py::2902::digitised_documents",
    "server.py::2931::digitised_documents",
    "server.py::2948::digitised_documents",
    "server.py::3030::digitised_documents",
    "server.py::3061::patients",
    "server.py::3084::digitised_documents",
    "server.py::3097::patients",
    "server.py::3172::gp_validation_sessions",
    "server.py::3229::digitised_documents",
    "server.py::3275::digitised_documents",
    "server.py::3299::digitised_documents",
    "server.py::3317::digitised_documents",
    "server.py::3339::digitised_documents",
    "server.py::3423::digitised_documents",
    "server.py::3458::digitised_documents",
    "server.py::3468::digitised_documents",
    "server.py::3494::digitised_documents",
    "server.py::3537::digitised_documents",
    "server.py::3556::digitised_documents",
    "server.py::3611::digitised_documents",
    "server.py::3631::digitised_documents",
    "server.py::3646::digitised_documents",
    "server.py::3668::digitised_documents",
    "server.py::3693::digitised_documents",
    "server.py::3704::gp_validation_sessions",
    "server.py::3731::gp_validation_sessions",
    "server.py::3805::digitised_documents",
    "server.py::3843::patients",
    "server.py::397::encounters",
    "server.py::435::encounters",
    "server.py::4422::encounters",
    "server.py::4447::clinical_notes",
    "server.py::4525::allergies",
    "server.py::4595::prescriptions",
    "server.py::4616::prescription_items",
    "server.py::4637::prescriptions",
    "server.py::4646::prescription_items",
    "server.py::4666::prescriptions",
    "server.py::4672::prescription_items",
    "server.py::4724::sick_notes",
    "server.py::4792::referrals",
    "server.py::4809::referrals",
    "server.py::487::allergies",
    "server.py::4921::patients",
    "server.py::4951::prescriptions",
    "server.py::4961::prescription_items",
    "server.py::5049::prescription_items",
    "server.py::505::allergies",
    "server.py::555::diagnoses",
    "server.py::615::diagnoses",
    "server.py::657::vitals",
    "server.py::683::vitals",
    "server.py::765::encounters",
}
