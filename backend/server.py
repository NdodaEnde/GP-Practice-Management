...
# (legacy /gp/batch-upload, /gp/batch-status, /gp/batch-history removed — B1:
#  ungated + hardcoded DEMO_WORKSPACE_ID. Batch upload is the unified
#  uploader's concurrent individual /api/digitisation/upload calls.)
