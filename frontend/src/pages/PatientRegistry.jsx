    ...
    <div className="space-y-6 animate-fade-in" data-testid="patient-registry-container">
      ...
      <Dialog open={checkInDialogOpen} onOpenChange={setCheckInDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold text-teal-700">Check-In Patient</DialogTitle>
          </DialogHeader>
            ...
            <div className="space-y-4 mt-4">
              <div className="p-4 bg-teal-50 border border-teal-200 rounded-lg">
                ...
                <p className="text-gray-700">
                  {newlyCreatedPatient.first_name} {newlyCreatedPatient.last_name}
                </p>
                <p className="text-sm text-gray-600">ID: {newlyCreatedPatient.id_number}</p>
              </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  value={checkInData.reason_for_visit}
                  onChange={(e) => setCheckInData({ ...checkInData, reason_for_visit: e.target.value })}
                  rows={3}
                  className="mt-1"
                />
              </div>
                ...
                <div className="flex gap-2 mt-2">
                  {['normal', 'urgent', 'emergency'].map((p) => (
                    <button
                      key={p}
                      type="button"
                      onClick={() => setCheckInData({ ...checkInData, priority: p })}
                      className={`
                        flex-1 px-3 py-2 rounded-lg border-2 font-medium capitalize transition-all text-sm
                        ${checkInData.priority === p
                          ? p === 'emergency' ? 'bg-red-100 text-red-800 border-red-300'
                            : p === 'urgent' ? 'bg-orange-100 text-orange-800 border-orange-300'
              ...
              <div className="flex gap-2 pt-4">
                ...
                <Button
                  ...
                  disabled={isCheckingIn || !checkInData.reason_for_visit.trim()}
