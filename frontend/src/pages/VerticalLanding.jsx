...
const VERTICALS = {
  ...
  mining: {
    ...
    heroEyebrow: 'Capital-Transition Intelligence',
    heroHeading: 'Public reports → a graph you can interrogate, with every figure cited.',
    heroBody:
      'A document-grounded Copilot for mining corporates. Every answer cites its source page and labels how certain it is — disclosed, derived, or strategically attributed. First account: Exxaro.',
    available: true,
    primaryCta: 'Sign In',
    secondaryCta: 'See Pricing',
    phases: [
      {
        ...
        body:
          'Annual + sustainability + investor reports → entities, financials, and capital-transition narratives, every fact source-linked to its page. Live for Exxaro today.',
        icon: ScanLine,
      },
      {
        eyebrow: 'Module 02',
        title: 'Occupational-Health & Litigation Records',
        body:
          'Employment + medical records for lung-disease litigation defence. Different buyer (legal / compliance), same provenance discipline. Planned.',
        icon: Activity,
      },
      {
        eyebrow: 'Roadmap',
        title: 'Contracts, Engineering Filings, ESG Audit',
        body:
          'Same substrate, new document types. Reuse of the extraction + provenance layer makes each new module gateway-work, not platform-work.',
        icon: Sparkles,
      },
    ],
    proofPoints: [
      'Every figure cites doc + page',
      'Honesty chip on every value (disclosed · derived · strategically attributed)',
      'Coal-to-renewable narratives stamped strategically_attributed by rule — never disclosed',
      'Eval gate on a human-captured gold set before any external demo',
      'Grounded retrieval (pgvector) for free-text Q&A',
      'Open-text refusal scoped to ingested content, not improvised',
    ],
  },
  logistics: {
    name: 'Logistics',
